...
def prep_ccn(ccnpath, predatapath, year, dt=3600):
    ...
    if dt >= 3600:
        ...
        ccn1_measure = median_time_1d(ccntime, ccn1, time_new, arraytype='xarray')
        ccn2_measure = median_time_1d(ccntime, ccn2, time_new, arraytype='xarray')
        ccn5_measure = median_time_1d(ccntime, ccn5, time_new, arraytype='xarray')
        ss1_i = median_time_1d(ccntime, ss1, time_new, arraytype='xarray')
        ss2_i = median_time_1d(ccntime, ss2, time_new, arraytype='xarray')
        ss5_i = median_time_1d(ccntime, ss5, time_new, arraytype='xarray')
    if dt < 3600:
        ...
        ccn1_measure = interp_time_1d(ccntime, ccn1, time_new, arraytype='xarray')
        ccn2_measure = interp_time_1d(ccntime, ccn2, time_new, arraytype='xarray')
        ccn5_measure = interp_time_1d(ccntime, ccn5, time_new, arraytype='xarray')
        ss1_i = interp_time_1d(ccntime, ss1, time_new, arraytype='xarray')
        ss2_i = interp_time_1d(ccntime, ss2, time_new, arraytype='xarray')
        ss5_i = interp_time_1d(ccntime, ss5, time_new, arraytype='xarray')
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
def prep_cloud_2d(armbepath, arsclpath, predatapath, height_out, year, dt=3600):
    """
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
def prep_cloudheight_ARSCL(arsclbndpath, predatapath, year, dt=3600):
    """
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
def prep_LWP(armbepath, mwrpath, predatapath, year, dt=3600):
    """
...
def prep_LTS(armbepath, arsclpath, predatapath, year, dt=3600):
    ...
    tmpthetadiff = xr.DataArray(data=np.array(thetadiff_cb), dims=["time"], coords=dict(time=time))
    ...
    if dt < 3600:
        ...
        # thetadiff_new = interp_time_1d(time.astype("float"), thetadiff_cb, time_new.astype("float"))
        ...
        thetadiff_new = interp_time_1d(time, tmpthetadiff, time_new, arraytype='xarray')
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
def prep_precip(armbepath, metpath, parspath, predatapath, year, dt=3600):
    """
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
def prep_radiation(armbepath, radfluxpath, predatapath, year, dt=3600):
    """
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
def prep_totcld(armbepath, arsclbndpath, tsipath, predatapath, year, dt=3600):
    """
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
def prep_Nd_ARMretrieval(mfrsrpath, arsclbndpath, mwrpath, predatapath, year, dt=3600):
    """
