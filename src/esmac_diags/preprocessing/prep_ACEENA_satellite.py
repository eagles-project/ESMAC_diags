...
def prep_VISST_grid(visstgridpath, predatapath, dt=3600):
    ...
    Nd_new = avg_time_1d(vissttime, Nd_array, time_new, datatype='xarray')
    H_new = avg_time_1d(vissttime, H, time_new, datatype='xarray')
    lwp_new = avg_time_1d(vissttime, lwp, time_new, datatype='xarray')
    iwp_new = avg_time_1d(vissttime, iwp, time_new, datatype='xarray')
    swnetsfc_new = avg_time_1d(vissttime, sfc_net_sw, time_new, datatype='xarray')
    lwnetsfc_new = avg_time_1d(vissttime, sfc_net_lw, time_new, datatype='xarray')
    swdnsfc_new = avg_time_1d(vissttime, sfc_down_sw, time_new, datatype='xarray')
    lwdnsfc_new = avg_time_1d(vissttime, sfc_down_lw, time_new, datatype='xarray')
    reff_new = avg_time_1d(vissttime, reff_liq, time_new, datatype='xarray')
    cod_new = avg_time_1d(vissttime, cod_liq_linavg, time_new, datatype='xarray')
    codlog_new = avg_time_1d(vissttime, cod_liq_logavg, time_new, datatype='xarray')
    cf_all_new = avg_time_1d(vissttime, cf_allz, time_new, datatype='xarray')
    cf_low_new = avg_time_1d(vissttime, cf_low, time_new, datatype='xarray')
    cf_mid_new = avg_time_1d(vissttime, cf_mid, time_new, datatype='xarray')
    cf_high_new = avg_time_1d(vissttime, cf_high, time_new, datatype='xarray')
    ctt_new = avg_time_1d(vissttime, ctt_liq, time_new, datatype='xarray')
    ctp_new = avg_time_1d(vissttime, ctp_liq, time_new, datatype='xarray')
    cth_new = avg_time_1d(vissttime, cth_liq, time_new, datatype='xarray')
    lw_new = avg_time_1d(vissttime, bb_lw_all, time_new, datatype='xarray')
    sw_new = avg_time_1d(vissttime, bb_sw_all, time_new, datatype='xarray')
    albedo_new = avg_time_1d(vissttime, bb_sw_albedo_all, time_new, datatype='xarray')
    solar_zenith_new = avg_time_1d(vissttime, solar_zenith, time_new, datatype='xarray')
...
def prep_VISST_pixel(visstpixpath, predatapath, dt=3600):
    ...
    lwp_new = avg_time_1d(vissttime, lwp, time_new, datatype='xarray')
    iwp_new = avg_time_1d(vissttime, iwp, time_new, datatype='xarray')
    reff_new = avg_time_1d(vissttime, reff, time_new, datatype='xarray')
    cod_new = avg_time_1d(vissttime, cod, time_new, datatype='xarray')
    ctt_new = avg_time_1d(vissttime, ctt, time_new, datatype='xarray')
    ctp_new = avg_time_1d(vissttime, ctp, time_new, datatype='xarray')
    cth_new = avg_time_1d(vissttime, cth, time_new, datatype='xarray')
    lw_new = avg_time_1d(vissttime, bb_lw, time_new, datatype='xarray')
    sw_new = avg_time_1d(vissttime, bb_sw, time_new, datatype='xarray')
    albedo_new = avg_time_1d(vissttime, bb_sw_albedo, time_new, datatype='xarray')
