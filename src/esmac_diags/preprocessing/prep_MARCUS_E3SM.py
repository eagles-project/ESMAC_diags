...
# output_path = 'C:/Users/tang357/Downloads/MARCUS/'
...
def prep_E3SM_sfc(input_path, input2d_filehead, input3d_filehead, input3d_dryaerosol_filehead, input3d_cloudaerosol_filehead, input_cosp_filehead, output_path, output_filehead, shipmetpath, dt=3600, config=config):
    ...
    print(ttt.ctime(ttt.time())+': read ship location data:')
    ...
    # lst.sort()
    lst3d = glob.glob(input_path + input3d_filehead+'.*2017-10-2?-*.nc') + \
            glob.glob(input_path + input3d_filehead+'.*2017-10-3?-*.nc') + \
            glob.glob(input_path + input3d_filehead+'.*2017-11-??-*.nc') + \
            glob.glob(input_path + input3d_filehead+'.*2017-12-??-*.nc') + \
            glob.glob(input_path + input3d_filehead+'.*2018-01-??-*.nc') + \
            glob.glob(input_path + input3d_filehead+'.*2018-02-??-*.nc') + \
            glob.glob(input_path + input3d_filehead+'.*2018-03-??-*.nc')
    lst3d_dryaer = glob.glob(input_path + input3d_dryaerosol_filehead+'.*2017-10-2?-*.nc') + \
            glob.glob(input_path + input3d_dryaerosol_filehead+'.*2017-10-3?-*.nc') + \
            glob.glob(input_path + input3d_dryaerosol_filehead+'.*2017-11-??-*.nc') + \
            glob.glob(input_path + input3d_dryaerosol_filehead+'.*2017-12-??-*.nc') + \
            glob.glob(input_path + input3d_dryaerosol_filehead+'.*2018-01-??-*.nc') + \
            glob.glob(input_path + input3d_dryaerosol_filehead+'.*2018-02-??-*.nc') + \
            glob.glob(input_path + input3d_dryaerosol_filehead+'.*2018-03-??-*.nc')
    lst3d_wetaer = glob.glob(input_path + input3d_cloudaerosol_filehead+'.*2017-10-2?-*.nc') + \
            glob.glob(input_path + input3d_cloudaerosol_filehead+'.*2017-10-3?-*.nc') + \
            glob.glob(input_path + input3d_cloudaerosol_filehead+'.*2017-11-??-*.nc') + \
            glob.glob(input_path + input3d_cloudaerosol_filehead+'.*2017-12-??-*.nc') + \
            glob.glob(input_path + input3d_cloudaerosol_filehead+'.*2018-01-??-*.nc') + \
            glob.glob(input_path + input3d_cloudaerosol_filehead+'.*2018-02-??-*.nc') + \
            glob.glob(input_path + input3d_cloudaerosol_filehead+'.*2018-03-??-*.nc')
    lst2d = glob.glob(input_path + input2d_filehead+'.*2017-10-2?-*.nc') + \
            glob.glob(input_path + input2d_filehead+'.*2017-10-3?-*.nc') + \
            glob.glob(input_path + input2d_filehead+'.*2017-11-??-*.nc') + \
            glob.glob(input_path + input2d_filehead+'.*2017-12-??-*.nc') + \
            glob.glob(input_path + input2d_filehead+'.*2018-01-??-*.nc') + \
            glob.glob(input_path + input2d_filehead+'.*2018-02-??-*.nc') + \
            glob.glob(input_path + input2d_filehead+'.*2018-03-??-*.nc')
    lstcosp = glob.glob(input_path + input_cosp_filehead+'.*2017-10-2?-*.nc') + \
            glob.glob(input_path + input_cosp_filehead+'.*2017-10-3?-*.nc') + \
            glob.glob(input_path + input_cosp_filehead+'.*2017-11-??-*.nc') + \
            glob.glob(input_path + input_cosp_filehead+'.*2017-12-??-*.nc') + \
            glob.glob(input_path + input_cosp_filehead+'.*2018-01-??-*.nc') + \
            glob.glob(input_path + input_cosp_filehead+'.*2018-02-??-*.nc') + \
            glob.glob(input_path + input_cosp_filehead+'.*2018-03-??-*.nc')
    lst3d.sort()
    lst3d_dryaer.sort()
    lst3d_wetaer.sort()
    lst2d.sort()
...
def prep_E3SM_profiles(input_path, input2d_filehead, input3d_filehead, output_path, output_filehead, shipmetpath,
    ...
    T = e3smdata3d[config['T']+E3SMdomain_range][:,:,x_idx_all].load()
    # Q = e3smdata3d[config['Q']+E3SMdomain_range][:,:,x_idx_all].load()
    # U = e3smdata3d[config['U']+E3SMdomain_range][:,:,x_idx_all].load()
    # V = e3smdata3d[config['V']+E3SMdomain_range][:,:,x_idx_all].load()
    # RH = e3smdata3d[config['RH']+E3SMdomain_range][:,:,x_idx_all].load()
    if config['cloudfraction3d_legit'] == True:
        cloud = e3smdata3d[config['CF']+E3SMdomain_range][:,:,x_idx_all].load()
    else:
        cloud = e3smdata3d[config['CFLIQ']+E3SMdomain_range][:,:,x_idx_all].load() + e3smdata3d[config['CFICE']+E3SMdomain_range][:,:,x_idx_all].load()
    ...
    ps = e3smdata2d[config['PS']+E3SMdomain_range][:,x_idx_all].load()
    Ts = e3smdata2d[config['TS']+E3SMdomain_range][:,x_idx_all].load()
    if config['midlevel_thermo_output'] == True:
        theta700 = e3smdata2d[config['THETA700']+E3SMdomain_range][:,x_idx_all].load()
        # theta850 = e3smdata2d[config['THETA850']+E3SMdomain_range][:,x_idx_all].load()
                        
    if config['pres_output'] == False:
        p0 = e3smdata3d[config['P0']].load()
        levm = 0.01* (ps*hybm + hyam*p0)  # hPa
    else:
        levm = e3smdata3d[config['PRES']+E3SMdomain_range][:,:,x_idx_all].load()
    ...
    for ii in np.arange(len(lst3d[1:]))+1:
        ...
        Ts = e3smdata2d[config['TS']+E3SMdomain_range][:, x_idx_all].load()
        if config['midlevel_thermo_output'] == True:
            theta700_2 = e3smdata2d[config['THETA700']+E3SMdomain_range][:,x_idx_all].load()
            # theta850_2 = e3smdata2d[config['THETA850']+E3SMdomain_range][:,x_idx_all].load()
