...
def prep_E3SM_flight(input_path, input_filehead, output_path, output_filehead, 
                      iwgpath, E3SMdomain_range='', dt=60):
    """
    ...
    for filename in lst0[:]:
        ...
        if len(lst)==0:
            print('WARNING: do not have model output for this day, skip...'+date)
            continue
        elif len(lst)!=1:
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
def prep_E3SM_sfc(input_path, input_filehead, output_path, output_filehead, 
                  E3SMdomain_range='', dt=3600):
    """
