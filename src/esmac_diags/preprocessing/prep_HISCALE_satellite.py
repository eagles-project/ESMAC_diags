"""
prepare satellite data from HISCALE
...
#%% test settings
# visstgridpath = '../../../data/HISCALE/obs/satellite/visst/grid/'
# visstpixpath = '../../../data/HISCALE/obs/satellite/visst/pix_3x3/'
# predatapath = 'C:/Users/tang357/Downloads/HISCALE/'
# dt=3600


#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
def prep_VISST_grid(visstgridpath, predatapath, dx=0.5, dt=3600):
    """
    ...
    #%% output file
    outfile = predatapath + 'Nd_VISSTgrid_HISCALE.nc'
    ...
    #
    outfile = predatapath + 'Hcld_VISSTgrid_HISCALE.nc'
    print('output file '+outfile)
    ds = xr.Dataset({
    ...
    #
    outfile = predatapath + 'LWP_VISSTgrid_HISCALE.nc'
    print('output file '+outfile)
    ds = xr.Dataset({
    ...
    #
    outfile = predatapath + 'IWP_VISSTgrid_HISCALE.nc'
    print('output file '+outfile)
    ds = xr.Dataset({
    ...
    #
    outfile = predatapath + 'Reff_VISSTgrid_HISCALE.nc'
    print('output file '+outfile)
    ds = xr.Dataset({
    ...
    #
    outfile = predatapath + 'cod_VISSTgrid_HISCALE.nc'
    print('output file '+outfile)
    ds = xr.Dataset({
    ...
    #
    outfile = predatapath + 'cloudfraction_VISSTgrid_HISCALE.nc'
    print('output file '+outfile)
    ds = xr.Dataset({
    ...
    #
    outfile = predatapath + 'cloudtop_VISSTgrid_HISCALE.nc'
    print('output file '+outfile)
    ds = xr.Dataset({
    ...
    #
    outfile = predatapath + 'lwflx_VISSTgrid_HISCALE.nc'
    print('output file '+outfile)
    ds = xr.Dataset({
    ...
    #
    outfile = predatapath + 'swflx_VISSTgrid_HISCALE.nc'
    print('output file '+outfile)
    ds = xr.Dataset({
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
def prep_VISST_pixel(visstpixpath, predatapath, dx=4, dt=3600):
    """
    ...
    #
    outfile = predatapath + 'Hcld_VISSTpix_HISCALE.nc'
    print('output file '+outfile)
    ds = xr.Dataset({
                    'Hcld': (['time'], np.float32(H_new)),
                    },
    ...
    #
    outfile = predatapath + 'LWP_VISSTpix_HISCALE.nc'
    print('output file '+outfile)
    ds = xr.Dataset({
                    'lwp': (['time'], np.float32(lwp_new)),
                    },
    ...
    #
    outfile = predatapath + 'IWP_VISSTpix_HISCALE.nc'
    print('output file '+outfile)
    ds = xr.Dataset({
                    'iwp': (['time'], np.float32(iwp_new)),
                    },
    ...
    #
    outfile = predatapath + 'Reff_VISSTpix_HISCALE.nc'
    print('output file '+outfile)
    ds = xr.Dataset({
                    'reff': (['time'], np.float32(reff_new)),
                    },
    ...
    #
    outfile = predatapath + 'cod_VISSTpix_HISCALE.nc'
    print('output file '+outfile)
    ds = xr.Dataset({
                    'cod': (['time'], np.float32(cod_new)),
                    },
    ...
    #
    outfile = predatapath + 'cloudtop_VISSTpix_HISCALE.nc'
    print('output file '+outfile)
    ds = xr.Dataset({
                    'ctt': (['time'], np.float32(ctt_new)),
                    'cth': (['time'], np.float32(cth_new)),
    ...
    #
    outfile = predatapath + 'lwflx_VISSTpix_HISCALE.nc'
    print('output file '+outfile)
    ds = xr.Dataset({
                    'lwnettoa': (['time'], np.float32(lw_new)),
                    },
    ...
    #
    outfile = predatapath + 'swflx_VISSTpix_HISCALE.nc'
    print('output file '+outfile)
    ds = xr.Dataset({
                    'swnettoa': (['time'], np.float32(sw_new)),
                    },
