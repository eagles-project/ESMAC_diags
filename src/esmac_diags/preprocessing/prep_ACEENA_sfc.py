...
def prep_ccn(ccnpath, predatapath, dt=3600):
    ...
    if dt >= 3600:
        ccn1_measure = median_time_1d(time, ccn1, time_new, arraytype='xarray')
        ss1_i = median_time_1d(time, ss1, time_new, arraytype='xarray')
        ccn2_measure = median_time_1d(time, ccn2, time_new, arraytype='xarray')
        ss2_i = median_time_1d(time, ss2, time_new, arraytype='xarray')
        ccn5_measure = median_time_1d(time, ccn5, time_new, arraytype='xarray')
        ss5_i = median_time_1d(time, ss5, time_new, arraytype='xarray')
    ...
    if dt < 3600:
        ccn1_measure = interp_time_1d(time, ccn1, time_new, arraytype='xarray')
        ss1_i = interp_time_1d(time, ss1, time_new, arraytype='xarray')
        ccn2_measure = interp_time_1d(time, ccn2, time_new, arraytype='xarray')
        ss2_i = interp_time_1d(time, ss2, time_new, arraytype='xarray')
        ccn5_measure = interp_time_1d(time, ccn5, time_new, arraytype='xarray')
        ss5_i = interp_time_1d(time, ss5, time_new, arraytype='xarray')
...
def prep_Nd_ARMretrieval(mfrsrpath, arsclbndpath, mwrpath, predatapath, dt=3600):
    ...
    #%% read in data
    lst1 = glob.glob(os.path.join(arsclbndpath, 'enaarsclkazrbnd1kolliasC1.c*.nc'))
    lst1.sort()
    arscldata = xr.open_mfdataset(lst1, combine='by_coords')
    arscltime = arscldata['time']
