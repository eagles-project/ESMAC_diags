...
def prep_E3SM_profiles(input_path, input_filehead, output_path, output_filehead, 
    ...
    lwc = e3smdata['LWC'+E3SMdomain_range].load()
    iwc = e3smdata['IWC'+E3SMdomain_range].load()
    e3smdata.close()
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
def prep_E3SM_sfc(input_path, input_filehead, output_path, output_filehead, E3SMdomain_range='', dt=3600):
    """
    ...
    cod_m = e3smdata['TAUWMODIS'+E3SMdomain_range].load()*0.01   # need a correction due to CF problem
    ...
    for file in lst[1:]:
        ...
        icwnc = e3smdata['ICWNC'+E3SMdomain_range].load()
        cod_a = e3smdata['TOT_CLD_VISTAU'+E3SMdomain_range].load()
        cod_m = e3smdata['TAUWMODIS'+E3SMdomain_range].load()*0.01   # correction for CF problem
        solin = e3smdata['SOLIN'+E3SMdomain_range].load()
        rel = rel[:,:,x_idx]
        freql = freql[:,:,x_idx]
        icwnc = icwnc[:,:,x_idx]
