...
#                     figsize=(8,2), xlimit=None, ylimit=(1000,1030), 
...
fig,ax = plot.heatmap([nd_wu_magic.data,nd_sat_magic.data,nd_m_magic.data,nd_m2_magic.data],
                      [lwp_magic,lwp_sat_magic,lwp_m_magic,lwp_m2_magic],
                      [albedo_magic,albedo_magic,albedo_m_magic,albedo_m2_magic],vmax=60,
