"""
prepare all E3SM data for MAGIC ship tracks
inlcude:
    prep_MAGIC_E3SM in src/esmac_diags/preprocessing/
"""
...
import numpy as np
import esmac_diags
import esmac_diags.preprocessing.prep_MAGIC_E3SM as prep
...
output_path = '../prep_data/MAGIC/model/'
output_filehead = 'MAGIC'
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
prep.prep_E3SM_sfc(input_path, input2d_filehead, input3d_filehead, input3d_dryaerosol_filehead, input3d_cloudaerosol_filehead, input_cosp_filehead, output_path+'sfc_prof/'+str(surface_dt)+'s/', output_filehead, shipmetpath, dt=surface_dt, config=config)
prep.prep_E3SM_profiles(input_path, input2d_filehead, input3d_filehead, output_path+'sfc_prof/'+str(profile_dt)+'s/', output_filehead, shipmetpath, height_out, lev_out=lev_out, dt=profile_dt, config=config)
