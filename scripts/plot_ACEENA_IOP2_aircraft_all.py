...
# #%% joint histogram
# fig,ax = plot.jointhist([ccn5.data, ccn5_m.data, ccn5_m2.data], [nd.data, nd_m.data, nd_m2.data],
#                     xedges=np.arange(0,200,10), yedges=np.arange(0,200,10), 
#                     normalize_x=True, #xlimit=(0,1000), ylimit=(0,1000),
#                     xlabel=['0.5%CCN (cm$^{-3}$)','0.5%CCN (cm$^{-3}$)','0.5%CCN (cm$^{-3}$)'], 
...
# #%% scatter
# fig,ax = plot.scatter([ccn5.data, ccn5_m.data, ccn5_m2.data], [nd.data, nd_m.data, nd_m2.data],
#                       title=['Obs','E3SMv1','E3SMv2'], xlimit=(0,200), ylimit=(0,200),
#                     xlabel='0.5%CCN (cm$^{-3}$)', ylabel='Nd (cm$^{-3}$)', 
