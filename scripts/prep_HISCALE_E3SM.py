...
# prep.prep_E3SM_flight(input_path, input2d_filehead, input3d_filehead, output_path+'aircraft/'+aircraft_dt+'s/', output_filehead, iwgpath, dt=aircraft_dt, config=config)
# prep.prep_E3SM_sfc(input_path, input2d_filehead, input3d_filehead, output_path+'surface/'+surface_dt+'s/', output_filehead, dt=surface_dt, config=config)
prep.prep_E3SM_profiles(input_path, input2d_filehead, input3d_filehead, output_path+'profile/'+profile_dt+'s/', output_filehead, height_out, lev_out=lev_out, dt=profile_dt, config=config)
