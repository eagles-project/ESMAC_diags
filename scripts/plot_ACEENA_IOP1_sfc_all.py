...
time_aceena = pd.date_range(start='2017-06-21', end='2017-07-21', freq="3600s")
IOP = 'IOP1'
...
fig,ax = plot.diurnalcycle_2d([uhsasall_aceena.T, CNsize_m_aceena.T, CNsize_m2_aceena.T], 
                              ...
                              levellist=np.arange(0,5500,200), xlabel='Time (UTC)', ylabel='Diameter (nm)', 
...
fig,ax = plot.hist([org_aceena,org_m_aceena,org_m2_aceena], weights=[w1,w2,w3], bins=np.arange(0,5,0.2),
                    legend =['Obs','E3SMv1','E3SMv2',], color=['k','r','b'],
...
fig,ax = plot.hist([so4_aceena,so4_m_aceena,so4_m2_aceena], weights=[w1,w2,w3], bins=np.arange(0,3,0.1),
                    legend =['Obs','E3SMv1','E3SMv2',], color=['k','r','b'],
...
fig,ax = plot.hist([ccn2_aceena,ccn2_m_aceena,ccn2_m2_aceena], weights=[w1,w2,w3], bins=np.arange(0,500,20),
                    legend =['Obs','E3SMv1','E3SMv2',], color=['k','r','b'],
...
fig,ax = plot.hist([cpc10_withmask_aceena,ncn10_m_aceena,ncn10_m2_aceena], weights=[w0,w1,w2], bins=np.arange(0,9000,300),
                    legend = ['CPC_masked','E3SMv1','E3SMv2'], color=['k','r','b'],
...
fig,ax = plot.hist([uhsas100_aceena,ncn100_m_aceena,ncn100_m2_aceena], weights=[w0,w1,w2], bins=np.arange(0,500,20),
...
fig,ax = plot.hist([ndrop_aceena,nd_wu_aceena,nd_sat_aceena,nd_m_aceena,nd_m2_aceena],  weights=[w0,w00,w000,w1,w2], 
                   legend = ['Ndrop','Wu_etal','Satellite','E3SMv1','E3SMv2'], color=['k','m','gray','r','b'],
                    title = 'Nd '+site+' '+IOP, bins=np.arange(0,330,20), ylabel='Fraction', xlabel='cm$^{-3}$')
