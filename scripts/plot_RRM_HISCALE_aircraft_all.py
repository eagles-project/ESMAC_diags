...
for IOP in ['IOP1','IOP2']:
        ...
        figpath= '../figures/RRM/'+site+'/flight/'
        ...
        # read in E3SM data
        lst = sorted(glob.glob(prep_model_path + 'hiscale_RRMne30_'+IOP+'_flight_*.nc'))
        ...
        lst = sorted(glob.glob(prep_model_path + 'hiscale_RRM3km_'+IOP+'_flight_*.nc'))
        modeldata = xr.open_mfdataset(lst)
        ...
        lwc[lwc<1e-4] = np.nan
        lwc_m[lwc_m<1e-4] = np.nan
        lwc_m2[lwc_m2<1e-4] = np.nan
        ...
        fig,ax = plot.mean_size_witherror([size_beasd, np.arange(1,3001), np.arange(1,3001)], 
                                [beasd,ncn_m,ncn_m2], 
                          legend = ['BEASD','ne30', '3km_regrid'],color=['k','r','b'],
                          marker=['.',None,None], linestyles=['none','-','-'],
                          xlimit=(10, 1e4), ylimit=(1e-2,2e4), 
        ...
        fig,ax = plot.mean_size_witherror([size_nd, np.arange(1,1000), np.arange(1,1000)], 
                          ...
                          legend = ['MergedSD','ne30', '3km_regrid'],color=['k','r','b'], xlimit=(1, 1e3), ylimit=(1e-5,1e3), 
                          xlabel='Diameter ($\mu$m)', ylabel='dN/dlogDp (cm$^{-3}$)', 
                            title = 'Mean Cloud Droplet Size Distribution '+site+' '+IOP)
        fig.savefig(figpath+'mean_cloud_size_'+IOP+'.png',dpi=fig.dpi,bbox_inches='tight', pad_inches=1)
        ...
        fig,ax = plot.hist([org,org_m,org_m2], weights=[w0,w1,w2], bins=np.arange(0,6.2,0.2),color=['k','r','b'],
                                  legend = ['Obs','ne30', '3km_regrid'], title='Total Organic '+site+' '+IOP, 
        ...
        fig,ax = plot.hist([so4,so4_m,so4_m2], weights=[w0,w1,w2], bins=np.arange(0,5.2,0.2),color=['k','r','b'],
                                  legend = ['Obs','ne30', '3km_regrid'],title='Sulfate '+site+' '+IOP, 
                                  ylabel='Fraction', xlabel='${\mu}$g/m$^{3}$')
        ...
        fig,ax = plot.hist([ccn2,ccn2_m,ccn2_m2], weights=[w0,w1,w2], legend = ['Obs','ne30', '3km_regrid'], 
        ...
        fig,ax = plot.hist([ccn5,ccn5_m, ccn5_m2], weights=[w0,w1,w2], legend = ['Obs','ne30', '3km_regrid'], title='CCN (SS=0.5%) '+site+' '+IOP, 
                            color=['k','r','b'], bins=np.arange(0,2200,100), ylabel='Fraction', xlabel='cm$^{-3}$')
        fig.savefig(figpath+'hist_CCN5_'+IOP+'.png',dpi=fig.dpi,bbox_inches='tight', pad_inches=1)
        ...
        fig,ax = plot.hist([cpc3,ncn3_m,ncn3_m2], weights=[w0,w1,w2], bins=np.arange(0,29000,1000), legend = ['Obs','ne30', '3km_regrid'], 
                                color=['k','r','b'],title='Aerosol number (>3nm) '+site+' '+IOP, ylabel='Fraction', xlabel='cm$^{-3}$')
        fig.savefig(figpath+'hist_CPC3_'+IOP+'.png',dpi=fig.dpi,bbox_inches='tight', pad_inches=1)
        ...
        fig,ax = plot.hist([cpc10,ncn10_m,ncn10_m2], weights=[w0,w1,w2], bins=np.arange(0,22000,1000), legend = ['Obs','ne30', '3km_regrid'], 
        ...
        fig,ax = plot.hist([pcasp100, ncn100_m, ncn100_m2], weights=[w0,w1,w2], bins=np.arange(0,1500,50), legend = ['Obs','ne30', '3km_regrid'], 
        ...
        fig,ax = plot.hist([lwc, lwc_m, lwc_m2], weights=[w0,w1,w2], bins=np.arange(0.01,0.5,0.02), legend = ['Obs','ne30', '3km_regrid'], 
                                color=['k','r','b'], title='lwc '+site+' '+IOP, ylabel='Fraction', xlabel=lwc.units)
        # ax.set_yscale('log')
        # ax.set_ylim(1e-4,1)
        fig.savefig(figpath+'hist_lwc_'+IOP+'.png',dpi=fig.dpi,bbox_inches='tight', pad_inches=1)
        ...
        fig,ax = plot.hist([nd, nd_m, nd_m2], weights=[w0, w1, w2], bins=np.arange(1,510,20), legend = ['Obs','ne30', '3km_regrid'], 
        ...
        fig,ax = plot.hist([reff, reff_m, reff_m2], weights=[w0, w1, w2], bins=np.arange(3,30,1), legend = ['Obs','ne30', '3km_regrid'], 
        ...
        fig,ax = plot.percentile_z([org,org_m,org_m2], [height,height,height], 
                              ...
                              xlabel='$\mu$g/m$^3$', ylabel='height (m)', legend = ['Obs','ne30', '3km_regrid'], )
        fig.savefig(figpath+'percentile_z_org_'+IOP+'.png',dpi=fig.dpi,bbox_inches='tight', pad_inches=1)
        fig,ax = plot.percentile_z([so4, so4_m, so4_m2], [height,height,height,], 
                              height_bin, figsize=(3,8), title='Sulfate', color=['k','r','b'],
                              xlabel='$\mu$g/m$^3$', ylabel='height (m)', legend = ['Obs','ne30', '3km_regrid'], )
        fig.savefig(figpath+'percentile_z_so4_'+IOP+'.png',dpi=fig.dpi,bbox_inches='tight', pad_inches=1)
        
        fig,ax = plot.percentile_z([ccn2,ccn2_m,ccn2_m2], [height,height,height], 
                              height_bin, figsize=(3,8), title='CCN (0.2%)',color=['k','r','b'],
                              xlabel='cm$^{-3}$', ylabel='height (m)', legend = ['Obs','ne30', '3km_regrid'], )
        fig.savefig(figpath+'percentile_z_CCN2_'+IOP+'.png',dpi=fig.dpi,bbox_inches='tight', pad_inches=1)
        fig,ax = plot.percentile_z([ccn5,ccn5_m,ccn5_m2], [height,height,height], 
                              height_bin, figsize=(3,8), title='CCN (0.5%)',color=['k','r','b'],
                              xlabel='cm$^{-3}$', ylabel='height (m)', legend = ['Obs','ne30', '3km_regrid'], )
        fig.savefig(figpath+'percentile_z_CCN5_'+IOP+'.png',dpi=fig.dpi,bbox_inches='tight', pad_inches=1)
        
        fig,ax = plot.percentile_z([cpc3,ncn3_m,ncn3_m2], [height,height,height], 
                              height_bin, figsize=(3,8), title='CN (>3nm)',color=['k','r','b'],
                              xlabel='cm$^{-3}$', ylabel='height (m)', legend = ['Obs','ne30', '3km_regrid'], )
        fig.savefig(figpath+'percentile_z_CN3_'+IOP+'.png',dpi=fig.dpi,bbox_inches='tight', pad_inches=1)
        fig,ax = plot.percentile_z([cpc10,ncn10_m,ncn10_m2], [height,height,height], 
                              height_bin, figsize=(3,8), title='CN (>10nm)',color=['k','r','b'],
                              xlabel='cm$^{-3}$', ylabel='height (m)', legend = ['Obs','ne30', '3km_regrid'], )
        fig.savefig(figpath+'percentile_z_CN10_'+IOP+'.png',dpi=fig.dpi,bbox_inches='tight', pad_inches=1)
        fig,ax = plot.percentile_z([pcasp100, ncn100_m, ncn100_m2], [height,height,height], 
                              ...
                              xlabel='cm$^{-3}$', ylabel='height (m)', legend = ['Obs','ne30', '3km_regrid'], )
        fig.savefig(figpath+'percentile_z_CN100_'+IOP+'.png',dpi=fig.dpi,bbox_inches='tight', pad_inches=1)
        
        fig,ax = plot.percentile_z([lwc, lwc_m, lwc_m2], [height,height,height], 
                              height_bin, figsize=(3,8), title='LWC',color=['k','r','b'],
                              xlabel='g/m$^{3}$', ylabel='height (m)', legend = ['Obs','ne30', '3km_regrid'], )
        fig.savefig(figpath+'percentile_z_lwc_'+IOP+'.png',dpi=fig.dpi,bbox_inches='tight', pad_inches=1)
        
        fig,ax = plot.percentile_z([nd, nd_m, nd_m2], [height,height,height], 
                              height_bin, figsize=(3,8), title='Nd',color=['k','r','b'],
                              xlabel='cm$^{-3}$', ylabel='height (m)', legend = ['Obs','ne30', '3km_regrid'], )
        fig.savefig(figpath+'percentile_z_Nd_'+IOP+'.png',dpi=fig.dpi,bbox_inches='tight', pad_inches=1)
        
        fig,ax = plot.percentile_z([reff, reff_m, reff_m2], [height,height,height], 
                              height_bin, figsize=(3,8), title='Reff',color=['k','r','b'],
                              xlabel='$\mu$m', ylabel='height (m)', legend = ['Obs','ne30', '3km_regrid'], )
        fig.savefig(figpath+'percentile_z_Reff_'+IOP+'.png',dpi=fig.dpi,bbox_inches='tight', pad_inches=1)
        
        #%% calculate statistics
        calc.mean_std_percentiles([org,org_m,org_m2],legend=['Obs','ne30', '3km_regrid'], outfile=figpath+'statistics_1var_ORG_'+site+'_'+IOP+'.txt')
        calc.mean_std_percentiles([so4, so4_m, so4_m2],legend=['Obs','ne30', '3km_regrid'], outfile=figpath+'statistics_1var_SO4_'+site+'_'+IOP+'.txt')
        calc.mean_std_percentiles([ccn2,ccn2_m,ccn2_m2],legend=['Obs','ne30', '3km_regrid'], outfile=figpath+'statistics_1var_CCN2_'+site+'_'+IOP+'.txt')
        calc.mean_std_percentiles([ccn5,ccn5_m,ccn5_m2],legend=['Obs','ne30', '3km_regrid'], outfile=figpath+'statistics_1var_CCN5_'+site+'_'+IOP+'.txt')
        calc.mean_std_percentiles([cpc3,ncn3_m,ncn3_m2],legend=['Obs','ne30', '3km_regrid'], outfile=figpath+'statistics_1var_CPC3_'+site+'_'+IOP+'.txt')
        calc.mean_std_percentiles([cpc10,ncn10_m,ncn10_m2],legend=['Obs','ne30', '3km_regrid'], outfile=figpath+'statistics_1var_CPC10_'+site+'_'+IOP+'.txt')
        calc.mean_std_percentiles([pcasp100, ncn100_m, ncn100_m2],legend=['Obs','ne30', '3km_regrid'], outfile=figpath+'statistics_1var_PCASP100_'+site+'_'+IOP+'.txt')
        calc.mean_std_percentiles([lwc, lwc_m, lwc_m2],legend=['Obs','ne30', '3km_regrid'], outfile=figpath+'statistics_1var_lwc_'+site+'_'+IOP+'.txt')
        calc.mean_std_percentiles([nd, nd_m, nd_m2],legend=['Obs','ne30', '3km_regrid'], outfile=figpath+'statistics_1var_Nd_'+site+'_'+IOP+'.txt')
        calc.mean_std_percentiles([reff, reff_m, reff_m2], legend=['Obs','ne30', '3km_regrid'], outfile=figpath+'statistics_1var_Reff_'+site+'_'+IOP+'.txt')
        
        calc.bias_corrcoef_RMSE(org,org_m,label1='Obs',label2='RRMne30', 
                                outfile=figpath+'statistics_ORG_RRMne30vsOBS_'+site+'_'+IOP+'.txt')
        calc.bias_corrcoef_RMSE(org,org_m2,label1='Obs',label2='RRM3km', 
                                outfile=figpath+'statistics_ORG_RRM3kmvsOBS_'+site+'_'+IOP+'.txt')
        
        calc.bias_corrcoef_RMSE(so4, so4_m,label1='Obs',label2='RRMne30', 
                                outfile=figpath+'statistics_SO4_RRMne30vsOBS_'+site+'_'+IOP+'.txt')
        calc.bias_corrcoef_RMSE(so4, so4_m2,label1='Obs',label2='RRM3km', 
                                outfile=figpath+'statistics_SO4_RRM3kmvsOBS_'+site+'_'+IOP+'.txt')
        
        calc.bias_corrcoef_RMSE(ccn2,ccn2_m,label1='Obs',label2='RRMne30', 
                                outfile=figpath+'statistics_CCN2_RRMne30vsOBS_'+site+'_'+IOP+'.txt')
        calc.bias_corrcoef_RMSE(ccn2,ccn2_m2,label1='Obs',label2='RRM3km', 
                                outfile=figpath+'statistics_CCN2_RRM3kmvsOBS_'+site+'_'+IOP+'.txt')
        
        calc.bias_corrcoef_RMSE(ccn5,ccn5_m,label1='Obs',label2='RRMne30', 
                                outfile=figpath+'statistics_CCN5_RRMne30vsOBS_'+site+'_'+IOP+'.txt')
        calc.bias_corrcoef_RMSE(ccn5,ccn5_m2,label1='Obs',label2='RRM3km', 
                                outfile=figpath+'statistics_CCN5_RRM3kmvsOBS_'+site+'_'+IOP+'.txt')
        
        calc.bias_corrcoef_RMSE(cpc3,ncn3_m,label1='Obs',label2='RRMne30', 
                                outfile=figpath+'statistics_CN3nm_RRMne30vsOBS_'+site+'_'+IOP+'.txt')
        calc.bias_corrcoef_RMSE(cpc3,ncn3_m2,label1='Obs',label2='RRM3km', 
                                outfile=figpath+'statistics_CN3nm_RRM3kmvsOBS_'+site+'_'+IOP+'.txt')
        
        calc.bias_corrcoef_RMSE(cpc10,ncn10_m,label1='Obs',label2='RRMne30', 
                                outfile=figpath+'statistics_CN10nm_RRMne30vsOBS_'+site+'_'+IOP+'.txt')
        calc.bias_corrcoef_RMSE(cpc10,ncn10_m2,label1='Obs',label2='RRM3km', 
                                outfile=figpath+'statistics_CN10nm_RRM3kmvsOBS_'+site+'_'+IOP+'.txt')
        
        calc.bias_corrcoef_RMSE(pcasp100, ncn100_m,label1='Obs',label2='RRMne30', 
                                outfile=figpath+'statistics_CN100_RRMne30vsOBS_'+site+'_'+IOP+'.txt')
        calc.bias_corrcoef_RMSE(pcasp100, ncn100_m2,label1='Obs',label2='RRM3km', 
                                outfile=figpath+'statistics_CN100_RRM3kmvsOBS_'+site+'_'+IOP+'.txt')
        
        calc.bias_corrcoef_RMSE(lwc, lwc_m,label1='Obs',label2='RRMne30', 
                                outfile=figpath+'statistics_LWC_RRMne30vsOBS_'+site+'_'+IOP+'.txt')
        if IOP=='IOP1':
            calc.bias_corrcoef_RMSE(lwc, lwc_m2,label1='Obs',label2='RRM3km', 
                                outfile=figpath+'statistics_LWC_RRM3kmvsOBS_'+site+'_'+IOP+'.txt')
        
        calc.bias_corrcoef_RMSE(nd, nd_m,label1='Obs',label2='RRMne30', 
                                outfile=figpath+'statistics_Nd_RRMne30vsOBS_'+site+'_'+IOP+'.txt')
        calc.bias_corrcoef_RMSE(nd, nd_m2,label1='Obs',label2='RRM3km', 
                                outfile=figpath+'statistics_Nd_RRM3kmvsOBS_'+site+'_'+IOP+'.txt')
        
        calc.bias_corrcoef_RMSE(reff, reff_m,label1='Obs',label2='RRMne30', 
                                outfile=figpath+'statistics_Reff_RRMne30vsOBS_'+site+'_'+IOP+'.txt')
        calc.bias_corrcoef_RMSE(reff, reff_m2,label1='Obs',label2='RRM3km', 
        ...
        fig,ax = plot.jointhist([pcasp100, ncn100_m, ncn100_m2],[ccn2.data, ccn2_m.data, ccn2_m2.data],
                            ...
                            ylabel='0.2%CCN (cm$^{-3}$)', title=['Obs','ne30', '3km_regrid'], )
        fig.savefig(figpath+'jointhist_CN_CCN2_'+IOP+'.png',dpi=fig.dpi,bbox_inches='tight', pad_inches=1)
        ...
        fig,ax = plot.jointhist([ccn2.data, ccn2_m.data, ccn2_m2.data], [nd.data, nd_m.data, nd_m2.data],
                            ...
                            ylabel='Nd (cm$^{-3}$)', title=['Obs','ne30', '3km_regrid'], )
        fig.savefig(figpath+'jointhist_Nd_CCN2_'+IOP+'.png',dpi=fig.dpi,bbox_inches='tight', pad_inches=1)
        ...
        fig,ax = plot.jointhist( [nd.data, nd_m.data, nd_m2.data],[lwc.data*1000, lwc_m.data*1000, lwc_m2.data*1000], 
                            ...
                            ylabel='LWC (mg/m$^{3}$)', title=['Obs','ne30', '3km_regrid'], )
        fig.savefig(figpath+'jointhist_LWC_Nd_'+IOP+'.png',dpi=fig.dpi,bbox_inches='tight', pad_inches=1)
        ...
        fig,ax = plot.jointhist([reff, reff_m, reff_m2],[lwc, lwc_m, lwc_m2],
                            ...
                            ylabel='LWC (g/m3)', title=['Obs','ne30', '3km_regrid'], )
        fig.savefig(figpath+'jointhist_LWC_Reff_'+IOP+'.png',dpi=fig.dpi,bbox_inches='tight', pad_inches=1)
        
        #%% scatter
        fig,ax = plot.scatter([ccn2.data, ccn2_m.data, ccn2_m2.data], [nd.data, nd_m.data, nd_m2.data],
                              title=['Obs','ne30', '3km_regrid'], xlimit=(0,800), ylimit=(0,500),
                            xlabel='0.2%CCN (cm$^{-3}$)', ylabel='Nd (cm$^{-3}$)', 
                            linear_fit=True, intercept=True)
        fig.savefig(figpath+'scatter_CCN_Nd_'+IOP+'.png',dpi=fig.dpi,bbox_inches='tight', pad_inches=1)
        
        
        fig,ax = plot.scatter([nd.data, nd_m.data, nd_m2.data], [reff.data, reff_m.data, reff_m2.data], 
                              title=['Obs','ne30', '3km_regrid'], xlimit=(0,500), ylimit=(0,50),
                            xlabel='Nd (cm$^{-3}$)', ylabel='Reff ($\mu$m)', 
                            linear_fit=False, intercept=True)
        fig.savefig(figpath+'scatter_Reff_Nd_'+IOP+'.png',dpi=fig.dpi,bbox_inches='tight', pad_inches=1)