...
h0=ax1.contourf(time_cf[0:-1:5], height_cf*0.001, cloudfraction[0:-1:5,:].T,np.arange(0,101,10),cmap='viridis')
...
ax3.plot(iwgtime,nd_air,color='k',linestyle='none',marker='.',alpha=0.2,markersize=1)
ax3.plot(mfrsrtime,nd_sfc,color=CB_color_cycle[1],linestyle='none',marker='.',alpha=0.4,markersize=1)
ax3.plot(time_wu,nd_wu,color=CB_color_cycle[3],linestyle='none',marker='.',markersize=1)
...
ax4.plot(iwgtime,reff_air,color='k',linestyle='none',marker='.',alpha=0.2,markersize=1)
ax4.plot(mfrsrtime,reff_sfc,color=CB_color_cycle[1],linestyle='none',marker='.',alpha=0.4,markersize=1)
ax4.plot(time_wu,reff_wu,color=CB_color_cycle[3],linestyle='none',marker='.',markersize=1)
...
plt.tight_layout()
fig.savefig(figpath+'/FigureS1_ACEENA.svg',dpi=fig.dpi,bbox_inches='tight', pad_inches=1)