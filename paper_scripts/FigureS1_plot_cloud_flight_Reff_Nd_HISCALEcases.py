...
ax4.plot(mfrsrtime,reff_sfc,color=CB_color_cycle[1],linestyle='none',marker='.',alpha=0.5,markersize=1)
...
fig.savefig(figpath+'/FigureS1_HISCALE.svg',dpi=fig.dpi,bbox_inches='tight', pad_inches=1)