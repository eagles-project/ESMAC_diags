...
# calculate Nd_sat
lwp = lwp.data*0.001 # to kg/m2
ctt = ctt_liq.data
cod = cod_liq_linavg.data
nd_sat = calc_cdnc_VISST(lwp, ctt, cod, adiabaticity=0.8)
...
ax2 = fig.add_subplot(3,1,2)
ax2.plot(iwgtime,reff_air,'k.',alpha=0.2,markersize=2)
ax2.plot(mfrsrtime,reff_sfc,'r.',markersize=2)
ax2.plot(time_wu,reff_wu,'violet',linestyle='none',marker='.',markersize=2)
ax2.plot(vissttime,reff_air_5,'k-',marker='o',label='Aircraft')
ax2.plot(vissttime,reff_sfc_5,'r-',marker='o',label='MFRSR/Ndrop')
ax2.plot(vissttime,reff_wu_5,'violet',linestyle='-',marker='o',label='Wu_etal')
ax2.plot(vissttime,reff_sat_5,'b-',marker='o',label='VISST')
# ax2.scatter(modistime,reff_21,300,color='g',linewidth=6,marker='x',label='MODIS',zorder=6)
# ax2.scatter(modistime,reff_16,100,color='g',linewidth=1,marker='x',zorder=6)
# ax2.scatter(modistime,reff_37,100,color='g',linewidth=1,marker='x',zorder=6)
# ax2.scatter(modistime,reff_1621,100,color='g',linewidth=1,marker='x',zorder=6)
...
ax3 = fig.add_subplot(3,1,3)
ax3.plot(iwgtime,nd_air,'k.',alpha=0.2,markersize=2)
ax3.plot(mfrsrtime,nd_sfc,'r.',markersize=2)
ax3.plot(time_wu,nd_wu,'violet',linestyle='none',marker='.',markersize=2)
ax3.plot(vissttime,nd_air_5,'k-',marker='o',label='Aircraft')
ax3.plot(vissttime,nd_sfc_5,'r-',marker='o',label='MFRSR/Ndrop')
ax3.plot(vissttime,nd_wu_5,'violet',linestyle='-',marker='o',label='Wu_etal')
ax3.plot(vissttime,nd_sat_5,'b-',marker='o',label='VISST')
# ax3.scatter([],[],300,color='g',linewidth=6,marker='x',label='MODIS')
ax3.set_ylim(-10,200)
ax3.set_title('Nd (cm$^{-3}$)')
ax3.legend(loc='upper left')
